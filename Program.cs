    ...
    class Program
    {
        static void Main(string[] args)
        {
            if (args.Length < 3)
            {
                ...
                Console.WriteLine("Give a list of files to merge followed by the name of the resulting merged text files.");
                Console.WriteLine("At least two file need to merge and and an output file must be given.");
